...
namespace QuizApplication_QuizAPI.Migrations
{
    ...
    [Migration("20250524090550_AddSeedUserAnswerTableToDbP2")]
    partial class AddSeedUserAnswerTableToDbP2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuizApplication_QuizAPI.Models.QuizAttempt", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            AttemptId = 1,
                            CreatedAt = new DateTime(2025, 5, 24, 14, 5, 50, 226, DateTimeKind.Local).AddTicks(730),
                            EndTime = new DateTime(2025, 5, 24, 14, 14, 20, 226, DateTimeKind.Local).AddTicks(83),
                            Passed = true,
                            QuizId = 1,
                            Score = 80.00m,
                            StartTime = new DateTime(2025, 5, 24, 14, 5, 50, 224, DateTimeKind.Local).AddTicks(8529),
                            UserId = 1
                        },
                        new
                        {
                            AttemptId = 2,
                            CreatedAt = new DateTime(2025, 5, 24, 15, 35, 50, 226, DateTimeKind.Local).AddTicks(883),
                            Passed = false,
                            QuizId = 1,
                            Score = 0.00m,
                            StartTime = new DateTime(2025, 5, 24, 15, 35, 50, 226, DateTimeKind.Local).AddTicks(881),
                            UserId = 2
                        },
                        new
                        {
                            AttemptId = 3,
                            CreatedAt = new DateTime(2025, 5, 24, 15, 5, 50, 226, DateTimeKind.Local).AddTicks(887),
                            EndTime = new DateTime(2025, 5, 24, 15, 18, 5, 226, DateTimeKind.Local).AddTicks(886),
                            Passed = false,
                            QuizId = 2,
                            Score = 50.00m,
                            StartTime = new DateTime(2025, 5, 24, 15, 5, 50, 226, DateTimeKind.Local).AddTicks(885),
                            UserId = 3
                        },
                        new
                        {
                            AttemptId = 4,
                            CreatedAt = new DateTime(2025, 5, 24, 15, 35, 50, 226, DateTimeKind.Local).AddTicks(890),
                            Passed = false,
                            QuizId = 2,
                            Score = 0.00m,
                            StartTime = new DateTime(2025, 5, 24, 15, 35, 50, 226, DateTimeKind.Local).AddTicks(889),
                            UserId = 1
                        });
                });
